...
public class SuperWeChatDBManager {
    ...
    public synchronized Integer saveMessage(InviteMessage message) {
        ...
        if (db.isOpen()) {
            ...
            values.put(InviteMessgeDao.COLUMN_NAME_NICK, message.getUserNick());
            values.put(InviteMessgeDao.COLUMN_NAME_AVATAR_SUFFIX, message.getAvatarSuffix());
            values.put(InviteMessgeDao.COLUMN_NAME_TIME, message.getAvatarTime());
    ...
    synchronized public List<InviteMessage> getMessagesList() {
        ...
        if (db.isOpen()) {
            ...
            while (cursor.moveToNext()) {
                ...
                String usernick = cursor.getString(cursor.getColumnIndex(InviteMessgeDao.COLUMN_NAME_NICK));
